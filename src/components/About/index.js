        ...
        <div className = "about">
            ...
            <div className = "total-container">
             <div className="first-container">
                ...
                <p className = "first-para">"Delivering Stunning <br/>Visual narratuves"</p>
                <p className = "first-paragraph">From concept to final edit, we tailor our production process to
                  suit your unique needs, ensuring the highest quality results.</p>
             </div>
             <div className = "second-container">
             <h3 className = "first-heading">our story</h3>
             <p className = "first-paragraph"> <span className = "first-para">PATCO PRODUCTIONS</span> has earned its reputation in the market
